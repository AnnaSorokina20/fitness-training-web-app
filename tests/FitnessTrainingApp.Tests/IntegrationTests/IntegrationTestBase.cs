...
public abstract class IntegrationTestBase
{
    ...
    {
        var user = TestDataFactory.CreateUser(id, fullName, role);
    ...
    protected static async Task<WorkoutComplex> AddWorkoutComplexAsync(
        FitnessTrainingDbContext context,
        string name = "Home Starter Plan",
        int trainerId = 1)
    {
        var complex = TestDataFactory.CreatePublishedWorkoutComplex(name, trainerId);
